...
export function ChessPiece({ piece, size = 40, className = "" }: ChessPieceProps) {
  // Simplified, high-performance chess pieces
  const pieceComponents = {
    // White pieces - simplified for performance
    wK: (
      <svg viewBox="0 0 45 45" className={className} width={size} height={size}>
        <g fill="#ffffff" stroke="#333333" strokeWidth="1.5">
    ...
    wQ: (
      <svg viewBox="0 0 45 45" className={className} width={size} height={size}>
        <g fill="#ffffff" stroke="#333333" strokeWidth="1.5">
          <circle cx="12.5" cy="7.5" r="2" fill="#ffd700" />
          <circle cx="17" cy="8" r="2" fill="#ffd700" />
          <circle cx="22.5" cy="7.5" r="2" fill="#ffd700" />
          <circle cx="28" cy="8" r="2" fill="#ffd700" />
          <circle cx="32.5" cy="7.5" r="2" fill="#ffd700" />
    ...
    wB: (
      <svg viewBox="0 0 45 45" className={className} width={size} height={size}>
        <g fill="#ffffff" stroke="#333333" strokeWidth="1.5">
          ...
          <circle cx="22.5" cy="8" r="2" fill="#ffd700" />
        </g>
      </svg>
    ),
    wN: (
      <svg viewBox="0 0 45 45" className={className} width={size} height={size}>
        <g fill="#ffffff" stroke="#333333" strokeWidth="1.5">
          ...
          <circle cx="9" cy="25.5" r="0.5" fill="#333333" />
        </g>
      </svg>
    ),
    wP: (
    ...
    bK: (
      <svg viewBox="0 0 45 45" className={className} width={size} height={size}>
        <g fill="#2a2a2a" stroke="#000000" strokeWidth="1.5">
          <path d="M 22.5,11.63 L 22.5,6" />
          <path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25" />
          <path d="M 11.5,37 C 17,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 20,16 10.5,13 6.5,19.5 C 3.5,25.5 12.5,30 12.5,30 L 11.5,37 z " />
          <path d="M 20,8 L 25,8" fill="none" stroke="#ffffff" />
        </g>
      </svg>
    ),
    bQ: (
  ...
  return pieceComponents[piece as keyof typeof pieceComponents] || null
}
